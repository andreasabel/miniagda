...
\newcommand{\inflet}{\rulename{inf-def}}
...
$\data \DD \: ( p_1 : P_1) \ldots ( p_n : P_n) : \Theta \ra \Set $\\
$\spc \cc_1 : \Delta_1 \ra \DD \: p_1 \ldots p_n \: t^1_1 \ldots t^1_m$\\
$\spc \ldots$\\   
$\spc \cc_k : \Delta_k \ra \DD \: p_1 \ldots p_n \: t^k_1 \ldots t^k_m$\\
\end{minipage}
}
...
\begin{bsp}
$\sized \data \DD \: ( p_1 : P_1) \ldots ( p_n : P_n) : \Size \ra \Theta \ra \Set $\\
$\spc \cc_1 : (i_1 : \Size) \ra \Delta_1 \ra \DD \: p_1 \ldots p_n \: (\s i_1) \: t^1_2 \ldots t^1_m$\\
$\spc \ldots$\\   
$\spc \cc_k : (i_k : \Size) \ra \Delta_k \ra \DD \: p_1 \ldots p_n \: (\s i_k) \: t^k_2 \ldots t^k_m$\\
\end{bsp}
\end{minipage}
}
...
As we will see, the use of $\Size$ needs to be constrained.
...
$\spc \spc \lop \inacc{\s i} \: (\zero i) f = \lopcase (\s i) \: f \: (f \: (\zero i))$\\
