...
\begin{description}
\item[weak-head evaluation]:
\begin{description}
\item
$ \wh : \Clos \ra \Val $
\item
$ \wh \; \lam{x}{e} \; \rho = \vlam \; x \; (e \rho) $
\item
$ \wh \; \EPi{x}{a}{b} \; \rho = \vpi \; x \; v_a (b \rho) $ \\
where $ v_a = \wh \; a \; \rho $ 
\item
$ \wh \; e \vec{e} \; \rho = \ap v \vec{v} $\\
where $ \vec{v} = \vec{e} \rho $
\item
$ \wh \; \Set \; \rho = \Set $ 
\item
$ \wh \; \Size \; \rho= \Size $
...
$ \wh \; \infty \; \rho= \infty $ 
\item
$ \wh \; \s e \; \rho= \sinfty \; v $ where $ v = \wh \; e $ 
\item
$ \wh \; \cc \; \rho= \cc $ 
\item
$ \wh \; \ff \; \rho= \ff $
\item
$ \wh \; \dd \; \rho = \wh \; e \; \diamond $ where $ \Sig \; \dd = (e,\_) $
\item
$ \wh \; x \; \rho = \lkup \; \rho \; x $
\end{description}
\item[Infty succesor]:
...
\begin{description}
\item
$ \ap : \Val \ra \vec{\Clos} \ra Val$
\item
$ \ap \; u \; \diamond = u$
\item
$ \ap \; (u \; \vec{c_1}) \; \vec{c_2} = \ap \; u (\vec{c_1}\;\vec{c_2})$
\item
$ \ap \; (\vlam \; x \; (e \; \rho)) \; (c \vec{c}) = \ap \; v \; \vec{c}$ \\
where $ v = \wh \; ( e \; (\ins \; \rho \; x \; c)) $ 
\item
$ \ap \; \ff \; \vec{c} = \apf \; \ff \; \vec{c} $ if $ \Sig \; \ff = (\ind,\_)$
\item
