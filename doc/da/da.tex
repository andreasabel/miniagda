...
\newcommand{\wkSNat}{\mathsf{wkSNat}\:}
...
\begin{abstract}
Dependent types have been used at the core of many proof asistants, and more recently there haven been efforts to extend their use to functional programming languages. 
...
While pattern mathing is intuitive and powerful, it has to be ensured that the defined functions are total. 
...
One is to allow the definition of functions where the recursive calls follow a certain scheme, for example primitive recursion.
